    ...
    return (
        <form action={action} className="space-y-8">
            <div className="space-y-2">
                ...
                {error.code && (
                    <div className="text-destructive">{error.code}</div>
                )}
            </div>
            <div className="space-y-2 gap-8 flex items-baseline">
                <div className="space-y-2">
                    ...
                    <RadioGroup
                        id="discountType"
                        name="discountType"
                        defaultValue={DiscountCodeType.PERCANTAGE}>
                        <div className="flex gap-2 items-center">
                            <RadioGroupItem
                                id="percentage"
                                value={DiscountCodeType.PERCANTAGE}
                            />
            ...
            <div className="space-y-2">
                ...
                {error.limit && (
                    <div className="text-destructive">{error.limit}</div>
                )}
            </div>
            <div className="space-y-2">
